...
MY_ROOT="${CONFIG_DIR}/.."
IMAGE_FILE="${MY_ROOT}/rr.img"
BOARD_PATH="${CONFIG_DIR}/board/rr"
...
echo "Copying files"
sudo cp "${BINARIES_DIR}/bzImage" "${BINARIES_DIR}/p3/bzImage-rr"
sudo cp "${BINARIES_DIR}/rootfs.cpio.xz" "${BINARIES_DIR}/p3/initrd-rr"
